...
module soc_system_mm_interconnect_0 (
		...
		input  wire [31:0] dsp_avalon_master_address,                                          //                                            dsp_avalon_master.address
		output wire        dsp_avalon_master_waitrequest,                                      //                                                             .waitrequest
		input  wire        dsp_avalon_master_write,                                            //                                                             .write
		input  wire [63:0] dsp_avalon_master_writedata,                                        //                                                             .writedata
	...
	wire          dsp_avalon_master_translator_avalon_universal_master_0_waitrequest;   // dsp_avalon_master_agent:av_waitrequest -> dsp_avalon_master_translator:uav_waitrequest
	wire   [63:0] dsp_avalon_master_translator_avalon_universal_master_0_readdata;      // dsp_avalon_master_agent:av_readdata -> dsp_avalon_master_translator:uav_readdata
	wire          dsp_avalon_master_translator_avalon_universal_master_0_debugaccess;   // dsp_avalon_master_translator:uav_debugaccess -> dsp_avalon_master_agent:av_debugaccess
	wire   [31:0] dsp_avalon_master_translator_avalon_universal_master_0_address;       // dsp_avalon_master_translator:uav_address -> dsp_avalon_master_agent:av_address
	wire          dsp_avalon_master_translator_avalon_universal_master_0_read;          // dsp_avalon_master_translator:uav_read -> dsp_avalon_master_agent:av_read
	wire    [7:0] dsp_avalon_master_translator_avalon_universal_master_0_byteenable;    // dsp_avalon_master_translator:uav_byteenable -> dsp_avalon_master_agent:av_byteenable
	wire          dsp_avalon_master_translator_avalon_universal_master_0_readdatavalid; // dsp_avalon_master_agent:av_readdatavalid -> dsp_avalon_master_translator:uav_readdatavalid
	wire          dsp_avalon_master_translator_avalon_universal_master_0_lock;          // dsp_avalon_master_translator:uav_lock -> dsp_avalon_master_agent:av_lock
	wire          dsp_avalon_master_translator_avalon_universal_master_0_write;         // dsp_avalon_master_translator:uav_write -> dsp_avalon_master_agent:av_write
	wire   [63:0] dsp_avalon_master_translator_avalon_universal_master_0_writedata;     // dsp_avalon_master_translator:uav_writedata -> dsp_avalon_master_agent:av_writedata
	wire    [3:0] dsp_avalon_master_translator_avalon_universal_master_0_burstcount;    // dsp_avalon_master_translator:uav_burstcount -> dsp_avalon_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                    // rsp_mux:src_valid -> dsp_avalon_master_agent:rp_valid
	wire  [145:0] rsp_mux_src_data;                                                     // rsp_mux:src_data -> dsp_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                    // dsp_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                  // rsp_mux:src_channel -> dsp_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                            // rsp_mux:src_startofpacket -> dsp_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                              // rsp_mux:src_endofpacket -> dsp_avalon_master_agent:rp_endofpacket
	...
	wire          dsp_avalon_master_agent_cp_valid;                                     // dsp_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [145:0] dsp_avalon_master_agent_cp_data;                                      // dsp_avalon_master_agent:cp_data -> router:sink_data
	wire          dsp_avalon_master_agent_cp_ready;                                     // router:sink_ready -> dsp_avalon_master_agent:cp_ready
	wire          dsp_avalon_master_agent_cp_startofpacket;                             // dsp_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dsp_avalon_master_agent_cp_endofpacket;                               // dsp_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) dsp_avalon_master_translator (
		.clk                    (clk_0_clk_clk),                                                        //                       clk.clk
		.reset                  (dsp_reset_sink_reset_bridge_in_reset_reset),                           //                     reset.reset
		.uav_address            (dsp_avalon_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dsp_avalon_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dsp_avalon_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dsp_avalon_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dsp_avalon_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dsp_avalon_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dsp_avalon_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dsp_avalon_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dsp_avalon_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dsp_avalon_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dsp_avalon_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (dsp_avalon_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (dsp_avalon_master_waitrequest),                                        //                          .waitrequest
		.av_write               (dsp_avalon_master_write),                                              //                          .write
		.av_writedata           (dsp_avalon_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dsp_avalon_master_agent (
		.clk                   (clk_0_clk_clk),                                                        //       clk.clk
		.reset                 (dsp_reset_sink_reset_bridge_in_reset_reset),                           // clk_reset.reset
		.av_address            (dsp_avalon_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dsp_avalon_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dsp_avalon_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dsp_avalon_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dsp_avalon_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dsp_avalon_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dsp_avalon_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dsp_avalon_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dsp_avalon_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dsp_avalon_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dsp_avalon_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dsp_avalon_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dsp_avalon_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dsp_avalon_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dsp_avalon_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dsp_avalon_master_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_0_router router (
		.sink_ready         (dsp_avalon_master_agent_cp_ready),           //      sink.ready
		.sink_valid         (dsp_avalon_master_agent_cp_valid),           //          .valid
		.sink_data          (dsp_avalon_master_agent_cp_data),            //          .data
		.sink_startofpacket (dsp_avalon_master_agent_cp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (dsp_avalon_master_agent_cp_endofpacket),     //          .endofpacket
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (dsp_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
