...
module soc_system_mm_interconnect_1 (
		...
		output wire [7:0]  dsp_avalon_slave_address,                                         //                                           dsp_avalon_slave.address
		output wire        dsp_avalon_slave_write,                                           //                                                           .write
		output wire        dsp_avalon_slave_read,                                            //                                                           .read
		input  wire [31:0] dsp_avalon_slave_readdata,                                        //                                                           .readdata
		output wire [31:0] dsp_avalon_slave_writedata,                                       //                                                           .writedata
		output wire        dsp_avalon_slave_chipselect,                                      //                                                           .chipselect
	...
	wire          dsp_avalon_slave_agent_rf_source_valid;                                               // dsp_avalon_slave_agent:rf_source_valid -> dsp_avalon_slave_agent_rsp_fifo:in_valid
	wire  [129:0] dsp_avalon_slave_agent_rf_source_data;                                                // dsp_avalon_slave_agent:rf_source_data -> dsp_avalon_slave_agent_rsp_fifo:in_data
	wire          dsp_avalon_slave_agent_rf_source_ready;                                               // dsp_avalon_slave_agent_rsp_fifo:in_ready -> dsp_avalon_slave_agent:rf_source_ready
	wire          dsp_avalon_slave_agent_rf_source_startofpacket;                                       // dsp_avalon_slave_agent:rf_source_startofpacket -> dsp_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire          dsp_avalon_slave_agent_rf_source_endofpacket;                                         // dsp_avalon_slave_agent:rf_source_endofpacket -> dsp_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire          dsp_avalon_slave_agent_rsp_fifo_out_valid;                                            // dsp_avalon_slave_agent_rsp_fifo:out_valid -> dsp_avalon_slave_agent:rf_sink_valid
	wire  [129:0] dsp_avalon_slave_agent_rsp_fifo_out_data;                                             // dsp_avalon_slave_agent_rsp_fifo:out_data -> dsp_avalon_slave_agent:rf_sink_data
	wire          dsp_avalon_slave_agent_rsp_fifo_out_ready;                                            // dsp_avalon_slave_agent:rf_sink_ready -> dsp_avalon_slave_agent_rsp_fifo:out_ready
	wire          dsp_avalon_slave_agent_rsp_fifo_out_startofpacket;                                    // dsp_avalon_slave_agent_rsp_fifo:out_startofpacket -> dsp_avalon_slave_agent:rf_sink_startofpacket
	wire          dsp_avalon_slave_agent_rsp_fifo_out_endofpacket;                                      // dsp_avalon_slave_agent_rsp_fifo:out_endofpacket -> dsp_avalon_slave_agent:rf_sink_endofpacket
	wire          dsp_avalon_slave_agent_rdata_fifo_src_valid;                                          // dsp_avalon_slave_agent:rdata_fifo_src_valid -> dsp_avalon_slave_agent_rdata_fifo:in_valid
	wire   [33:0] dsp_avalon_slave_agent_rdata_fifo_src_data;                                           // dsp_avalon_slave_agent:rdata_fifo_src_data -> dsp_avalon_slave_agent_rdata_fifo:in_data
	wire          dsp_avalon_slave_agent_rdata_fifo_src_ready;                                          // dsp_avalon_slave_agent_rdata_fifo:in_ready -> dsp_avalon_slave_agent:rdata_fifo_src_ready
	wire   [15:0] adc_slave_agent_m0_readdata;                                                          // adc_slave_translator:uav_readdata -> adc_slave_agent:m0_readdata
	...
	wire   [31:0] adc_slave_agent_m0_address;                                                           // adc_slave_agent:m0_address -> adc_slave_translator:uav_address
	wire    [1:0] adc_slave_agent_m0_byteenable;                                                        // adc_slave_agent:m0_byteenable -> adc_slave_translator:uav_byteenable
	...
	wire   [15:0] adc_slave_agent_m0_writedata;                                                         // adc_slave_agent:m0_writedata -> adc_slave_translator:uav_writedata
	wire          adc_slave_agent_m0_write;                                                             // adc_slave_agent:m0_write -> adc_slave_translator:uav_write
	wire    [1:0] adc_slave_agent_m0_burstcount;                                                        // adc_slave_agent:m0_burstcount -> adc_slave_translator:uav_burstcount
	wire          adc_slave_agent_rf_source_valid;                                                      // adc_slave_agent:rf_source_valid -> adc_slave_agent_rsp_fifo:in_valid
	wire  [111:0] adc_slave_agent_rf_source_data;                                                       // adc_slave_agent:rf_source_data -> adc_slave_agent_rsp_fifo:in_data
	...
	wire  [111:0] adc_slave_agent_rsp_fifo_out_data;                                                    // adc_slave_agent_rsp_fifo:out_data -> adc_slave_agent:rf_sink_data
	...
	wire          adc_slave_agent_rdata_fifo_src_valid;                                                 // adc_slave_agent:rdata_fifo_src_valid -> adc_slave_agent_rdata_fifo:in_valid
	wire   [17:0] adc_slave_agent_rdata_fifo_src_data;                                                  // adc_slave_agent:rdata_fifo_src_data -> adc_slave_agent_rdata_fifo:in_data
	wire          adc_slave_agent_rdata_fifo_src_ready;                                                 // adc_slave_agent_rdata_fifo:in_ready -> adc_slave_agent:rdata_fifo_src_ready
	...
	wire          dsp_avalon_slave_agent_rp_valid;                                                      // dsp_avalon_slave_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] dsp_avalon_slave_agent_rp_data;                                                       // dsp_avalon_slave_agent:rp_data -> router_009:sink_data
	wire          dsp_avalon_slave_agent_rp_ready;                                                      // router_009:sink_ready -> dsp_avalon_slave_agent:rp_ready
	wire          dsp_avalon_slave_agent_rp_startofpacket;                                              // dsp_avalon_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          dsp_avalon_slave_agent_rp_endofpacket;                                                // dsp_avalon_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          adc_slave_agent_rp_valid;                                                             // adc_slave_agent:rp_valid -> router_010:sink_valid
	wire  [110:0] adc_slave_agent_rp_data;                                                              // adc_slave_agent:rp_data -> router_010:sink_data
	wire          adc_slave_agent_rp_ready;                                                             // router_010:sink_ready -> adc_slave_agent:rp_ready
	wire          adc_slave_agent_rp_startofpacket;                                                     // adc_slave_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          adc_slave_agent_rp_endofpacket;                                                       // adc_slave_agent:rp_endofpacket -> router_010:sink_endofpacket
	wire          router_010_src_valid;                                                                 // router_010:src_valid -> rsp_demux_005:sink_valid
	wire  [110:0] router_010_src_data;                                                                  // router_010:src_data -> rsp_demux_005:sink_data
	...
	wire          cmd_mux_004_src_valid;                                                                // cmd_mux_004:src_valid -> dsp_avalon_slave_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                                 // cmd_mux_004:src_data -> dsp_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                                // dsp_avalon_slave_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                              // cmd_mux_004:src_channel -> dsp_avalon_slave_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                        // cmd_mux_004:src_startofpacket -> dsp_avalon_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                          // cmd_mux_004:src_endofpacket -> dsp_avalon_slave_burst_adapter:sink0_endofpacket
	wire          dsp_avalon_slave_burst_adapter_source0_valid;                                         // dsp_avalon_slave_burst_adapter:source0_valid -> dsp_avalon_slave_agent:cp_valid
	wire  [128:0] dsp_avalon_slave_burst_adapter_source0_data;                                          // dsp_avalon_slave_burst_adapter:source0_data -> dsp_avalon_slave_agent:cp_data
	wire          dsp_avalon_slave_burst_adapter_source0_ready;                                         // dsp_avalon_slave_agent:cp_ready -> dsp_avalon_slave_burst_adapter:source0_ready
	wire    [5:0] dsp_avalon_slave_burst_adapter_source0_channel;                                       // dsp_avalon_slave_burst_adapter:source0_channel -> dsp_avalon_slave_agent:cp_channel
	wire          dsp_avalon_slave_burst_adapter_source0_startofpacket;                                 // dsp_avalon_slave_burst_adapter:source0_startofpacket -> dsp_avalon_slave_agent:cp_startofpacket
	wire          dsp_avalon_slave_burst_adapter_source0_endofpacket;                                   // dsp_avalon_slave_burst_adapter:source0_endofpacket -> dsp_avalon_slave_agent:cp_endofpacket
	wire          cmd_mux_005_src_valid;                                                                // cmd_mux_005:src_valid -> adc_slave_burst_adapter:sink0_valid
	wire  [110:0] cmd_mux_005_src_data;                                                                 // cmd_mux_005:src_data -> adc_slave_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                                // adc_slave_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                              // cmd_mux_005:src_channel -> adc_slave_burst_adapter:sink0_channel
	wire          cmd_mux_005_src_startofpacket;                                                        // cmd_mux_005:src_startofpacket -> adc_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                          // cmd_mux_005:src_endofpacket -> adc_slave_burst_adapter:sink0_endofpacket
	wire          adc_slave_burst_adapter_source0_valid;                                                // adc_slave_burst_adapter:source0_valid -> adc_slave_agent:cp_valid
	wire  [110:0] adc_slave_burst_adapter_source0_data;                                                 // adc_slave_burst_adapter:source0_data -> adc_slave_agent:cp_data
	wire          adc_slave_burst_adapter_source0_ready;                                                // adc_slave_agent:cp_ready -> adc_slave_burst_adapter:source0_ready
	wire    [5:0] adc_slave_burst_adapter_source0_channel;                                              // adc_slave_burst_adapter:source0_channel -> adc_slave_agent:cp_channel
	wire          adc_slave_burst_adapter_source0_startofpacket;                                        // adc_slave_burst_adapter:source0_startofpacket -> adc_slave_agent:cp_startofpacket
	wire          adc_slave_burst_adapter_source0_endofpacket;                                          // adc_slave_burst_adapter:source0_endofpacket -> adc_slave_agent:cp_endofpacket
	...
	wire          cmd_demux_003_src3_valid;                                                             // cmd_demux_003:src3_valid -> hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:in_valid
	wire  [128:0] cmd_demux_003_src3_data;                                                              // cmd_demux_003:src3_data -> hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:in_data
	wire          cmd_demux_003_src3_ready;                                                             // hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:in_ready -> cmd_demux_003:src3_ready
	wire    [5:0] cmd_demux_003_src3_channel;                                                           // cmd_demux_003:src3_channel -> hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:in_channel
	wire          cmd_demux_003_src3_startofpacket;                                                     // cmd_demux_003:src3_startofpacket -> hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_003_src3_endofpacket;                                                       // cmd_demux_003:src3_endofpacket -> hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:in_endofpacket
	wire          hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_valid;                  // hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:out_valid -> cmd_mux_005:sink0_valid
	wire  [110:0] hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_data;                   // hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:out_data -> cmd_mux_005:sink0_data
	wire          hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_ready;                  // cmd_mux_005:sink0_ready -> hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:out_ready
	wire    [5:0] hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_channel;                // hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:out_channel -> cmd_mux_005:sink0_channel
	wire          hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_startofpacket;          // hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:out_startofpacket -> cmd_mux_005:sink0_startofpacket
	wire          hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_endofpacket;            // hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter:out_endofpacket -> cmd_mux_005:sink0_endofpacket
	wire          cmd_demux_004_src3_valid;                                                             // cmd_demux_004:src3_valid -> hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:in_valid
	wire  [128:0] cmd_demux_004_src3_data;                                                              // cmd_demux_004:src3_data -> hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:in_data
	wire          cmd_demux_004_src3_ready;                                                             // hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:in_ready -> cmd_demux_004:src3_ready
	wire    [5:0] cmd_demux_004_src3_channel;                                                           // cmd_demux_004:src3_channel -> hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:in_channel
	wire          cmd_demux_004_src3_startofpacket;                                                     // cmd_demux_004:src3_startofpacket -> hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_004_src3_endofpacket;                                                       // cmd_demux_004:src3_endofpacket -> hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:in_endofpacket
	wire          hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_valid;                  // hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:out_valid -> cmd_mux_005:sink1_valid
	wire  [110:0] hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_data;                   // hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:out_data -> cmd_mux_005:sink1_data
	wire          hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_ready;                  // cmd_mux_005:sink1_ready -> hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:out_ready
	wire    [5:0] hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_channel;                // hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:out_channel -> cmd_mux_005:sink1_channel
	wire          hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_startofpacket;          // hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:out_startofpacket -> cmd_mux_005:sink1_startofpacket
	wire          hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_endofpacket;            // hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter:out_endofpacket -> cmd_mux_005:sink1_endofpacket
	...
	wire          rsp_demux_005_src0_valid;                                                             // rsp_demux_005:src0_valid -> adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:in_valid
	wire  [110:0] rsp_demux_005_src0_data;                                                              // rsp_demux_005:src0_data -> adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:in_data
	wire          rsp_demux_005_src0_ready;                                                             // adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:in_ready -> rsp_demux_005:src0_ready
	wire    [5:0] rsp_demux_005_src0_channel;                                                           // rsp_demux_005:src0_channel -> adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:in_channel
	wire          rsp_demux_005_src0_startofpacket;                                                     // rsp_demux_005:src0_startofpacket -> adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_005_src0_endofpacket;                                                       // rsp_demux_005:src0_endofpacket -> adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:in_endofpacket
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_valid;                  // adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:out_valid -> rsp_mux_003:sink3_valid
	wire  [128:0] adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_data;                   // adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:out_data -> rsp_mux_003:sink3_data
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_ready;                  // rsp_mux_003:sink3_ready -> adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:out_ready
	wire    [5:0] adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_channel;                // adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:out_channel -> rsp_mux_003:sink3_channel
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_startofpacket;          // adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:out_startofpacket -> rsp_mux_003:sink3_startofpacket
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_endofpacket;            // adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter:out_endofpacket -> rsp_mux_003:sink3_endofpacket
	wire          rsp_demux_005_src1_valid;                                                             // rsp_demux_005:src1_valid -> adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:in_valid
	wire  [110:0] rsp_demux_005_src1_data;                                                              // rsp_demux_005:src1_data -> adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:in_data
	wire          rsp_demux_005_src1_ready;                                                             // adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:in_ready -> rsp_demux_005:src1_ready
	wire    [5:0] rsp_demux_005_src1_channel;                                                           // rsp_demux_005:src1_channel -> adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:in_channel
	wire          rsp_demux_005_src1_startofpacket;                                                     // rsp_demux_005:src1_startofpacket -> adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_005_src1_endofpacket;                                                       // rsp_demux_005:src1_endofpacket -> adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:in_endofpacket
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_valid;                  // adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:out_valid -> rsp_mux_004:sink3_valid
	wire  [128:0] adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_data;                   // adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:out_data -> rsp_mux_004:sink3_data
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_ready;                  // rsp_mux_004:sink3_ready -> adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:out_ready
	wire    [5:0] adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_channel;                // adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:out_channel -> rsp_mux_004:sink3_channel
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_startofpacket;          // adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:out_startofpacket -> rsp_mux_004:sink3_startofpacket
	wire          adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_endofpacket;            // adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter:out_endofpacket -> rsp_mux_004:sink3_endofpacket
	...
	wire   [31:0] dsp_avalon_slave_agent_m0_readdata;                                                   // mm_interconnect_5:dsp_avalon_slave_agent_m0_readdata -> dsp_avalon_slave_agent:m0_readdata
	wire          dsp_avalon_slave_agent_m0_waitrequest;                                                // mm_interconnect_5:dsp_avalon_slave_agent_m0_waitrequest -> dsp_avalon_slave_agent:m0_waitrequest
	wire          dsp_avalon_slave_agent_m0_debugaccess;                                                // dsp_avalon_slave_agent:m0_debugaccess -> mm_interconnect_5:dsp_avalon_slave_agent_m0_debugaccess
	wire   [31:0] dsp_avalon_slave_agent_m0_address;                                                    // dsp_avalon_slave_agent:m0_address -> mm_interconnect_5:dsp_avalon_slave_agent_m0_address
	wire    [3:0] dsp_avalon_slave_agent_m0_byteenable;                                                 // dsp_avalon_slave_agent:m0_byteenable -> mm_interconnect_5:dsp_avalon_slave_agent_m0_byteenable
	wire          dsp_avalon_slave_agent_m0_read;                                                       // dsp_avalon_slave_agent:m0_read -> mm_interconnect_5:dsp_avalon_slave_agent_m0_read
	wire          dsp_avalon_slave_agent_m0_readdatavalid;                                              // mm_interconnect_5:dsp_avalon_slave_agent_m0_readdatavalid -> dsp_avalon_slave_agent:m0_readdatavalid
	wire          dsp_avalon_slave_agent_m0_lock;                                                       // dsp_avalon_slave_agent:m0_lock -> mm_interconnect_5:dsp_avalon_slave_agent_m0_lock
	wire   [31:0] dsp_avalon_slave_agent_m0_writedata;                                                  // dsp_avalon_slave_agent:m0_writedata -> mm_interconnect_5:dsp_avalon_slave_agent_m0_writedata
	wire          dsp_avalon_slave_agent_m0_write;                                                      // dsp_avalon_slave_agent:m0_write -> mm_interconnect_5:dsp_avalon_slave_agent_m0_write
	wire    [0:0] dsp_avalon_slave_agent_m0_burstcount;                                                 // dsp_avalon_slave_agent:m0_burstcount -> mm_interconnect_5:dsp_avalon_slave_agent_m0_burstcount
	wire   [31:0] mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_readdata;      // dsp_avalon_slave_translator:uav_readdata -> mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_readdata
	wire          mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_waitrequest;   // dsp_avalon_slave_translator:uav_waitrequest -> mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_waitrequest
	wire          mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_debugaccess;   // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_debugaccess -> dsp_avalon_slave_translator:uav_debugaccess
	wire   [31:0] mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_address;       // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_address -> dsp_avalon_slave_translator:uav_address
	wire    [3:0] mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_byteenable;    // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_byteenable -> dsp_avalon_slave_translator:uav_byteenable
	wire          mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_read;          // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_read -> dsp_avalon_slave_translator:uav_read
	wire          mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_readdatavalid; // dsp_avalon_slave_translator:uav_readdatavalid -> mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_readdatavalid
	wire          mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_lock;          // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_lock -> dsp_avalon_slave_translator:uav_lock
	wire   [31:0] mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_writedata;     // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_writedata -> dsp_avalon_slave_translator:uav_writedata
	wire          mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_write;         // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_write -> dsp_avalon_slave_translator:uav_write
	wire    [0:0] mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_burstcount;    // mm_interconnect_5:dsp_avalon_slave_translator_avalon_universal_slave_0_burstcount -> dsp_avalon_slave_translator:uav_burstcount
	...
	wire          dsp_avalon_slave_agent_rdata_fifo_out_valid;                                          // dsp_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] dsp_avalon_slave_agent_rdata_fifo_out_data;                                           // dsp_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          dsp_avalon_slave_agent_rdata_fifo_out_ready;                                          // avalon_st_adapter_004:in_0_ready -> dsp_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                    // avalon_st_adapter_004:out_0_valid -> dsp_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                     // avalon_st_adapter_004:out_0_data -> dsp_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                    // dsp_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                    // avalon_st_adapter_004:out_0_error -> dsp_avalon_slave_agent:rdata_fifo_sink_error
	wire          adc_slave_agent_rdata_fifo_out_valid;                                                 // adc_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_005:in_0_valid
	wire   [17:0] adc_slave_agent_rdata_fifo_out_data;                                                  // adc_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_005:in_0_data
	wire          adc_slave_agent_rdata_fifo_out_ready;                                                 // avalon_st_adapter_005:in_0_ready -> adc_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                    // avalon_st_adapter_005:out_0_valid -> adc_slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_005_out_0_data;                                                     // avalon_st_adapter_005:out_0_data -> adc_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                    // adc_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                    // avalon_st_adapter_005:out_0_error -> adc_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) dsp_avalon_slave_translator (
		.clk                    (pll_0_outclk2_clk),                                                                    //                      clk.clk
		.reset                  (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                                  //                    reset.reset
		.uav_address            (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_burstcount),    //                         .burstcount
		.uav_read               (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_read),          //                         .read
		.uav_write              (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_write),         //                         .write
		.uav_waitrequest        (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_byteenable),    //                         .byteenable
		.uav_readdata           (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_readdata),      //                         .readdata
		.uav_writedata          (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_writedata),     //                         .writedata
		.uav_lock               (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_lock),          //                         .lock
		.uav_debugaccess        (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_debugaccess),   //                         .debugaccess
		.av_address             (dsp_avalon_slave_address),                                                             //      avalon_anti_slave_0.address
		.av_write               (dsp_avalon_slave_write),                                                               //                         .write
		.av_read                (dsp_avalon_slave_read),                                                                //                         .read
		.av_readdata            (dsp_avalon_slave_readdata),                                                            //                         .readdata
		.av_writedata           (dsp_avalon_slave_writedata),                                                           //                         .writedata
		.av_chipselect          (dsp_avalon_slave_chipselect),                                                          //                         .chipselect
		.av_begintransfer       (),                                                                                     //              (terminated)
		.av_beginbursttransfer  (),                                                                                     //              (terminated)
		.av_burstcount          (),                                                                                     //              (terminated)
		.av_byteenable          (),                                                                                     //              (terminated)
	...
	altera_merlin_axi_master_ni #(
		...
		.aclk                   (pll_0_outclk2_clk),                                                 //              clk.clk
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) dsp_avalon_slave_agent (
		.clk                     (pll_0_outclk2_clk),                                    //             clk.clk
		.reset                   (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (dsp_avalon_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (dsp_avalon_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (dsp_avalon_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (dsp_avalon_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (dsp_avalon_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (dsp_avalon_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (dsp_avalon_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (dsp_avalon_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (dsp_avalon_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (dsp_avalon_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (dsp_avalon_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (dsp_avalon_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (dsp_avalon_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (dsp_avalon_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (dsp_avalon_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (dsp_avalon_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (dsp_avalon_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (dsp_avalon_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (dsp_avalon_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (dsp_avalon_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (dsp_avalon_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (dsp_avalon_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (dsp_avalon_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (dsp_avalon_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (dsp_avalon_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (dsp_avalon_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (dsp_avalon_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (dsp_avalon_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (dsp_avalon_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (dsp_avalon_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (dsp_avalon_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (dsp_avalon_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                    // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                    //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                     //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                    //                .error
		.rdata_fifo_src_ready    (dsp_avalon_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dsp_avalon_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (dsp_avalon_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                  //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dsp_avalon_slave_agent_rsp_fifo (
		.clk               (pll_0_outclk2_clk),                                   //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dsp_avalon_slave_agent_rf_source_data),               //        in.data
		.in_valid          (dsp_avalon_slave_agent_rf_source_valid),              //          .valid
		.in_ready          (dsp_avalon_slave_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (dsp_avalon_slave_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (dsp_avalon_slave_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (dsp_avalon_slave_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (dsp_avalon_slave_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (dsp_avalon_slave_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (dsp_avalon_slave_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (dsp_avalon_slave_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dsp_avalon_slave_agent_rdata_fifo (
		.clk               (pll_0_outclk2_clk),                                   //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (dsp_avalon_slave_agent_rdata_fifo_src_data),          //        in.data
		.in_valid          (dsp_avalon_slave_agent_rdata_fifo_src_valid),         //          .valid
		.in_ready          (dsp_avalon_slave_agent_rdata_fifo_src_ready),         //          .ready
		.out_data          (dsp_avalon_slave_agent_rdata_fifo_out_data),          //       out.data
		.out_valid         (dsp_avalon_slave_agent_rdata_fifo_out_valid),         //          .valid
		.out_ready         (dsp_avalon_slave_agent_rdata_fifo_out_ready),         //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (adc_slave_burst_adapter_source0_ready),               //              cp.ready
		.cp_valid                (adc_slave_burst_adapter_source0_valid),               //                .valid
		.cp_data                 (adc_slave_burst_adapter_source0_data),                //                .data
		.cp_startofpacket        (adc_slave_burst_adapter_source0_startofpacket),       //                .startofpacket
		.cp_endofpacket          (adc_slave_burst_adapter_source0_endofpacket),         //                .endofpacket
		.cp_channel              (adc_slave_burst_adapter_source0_channel),             //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) adc_slave_agent_rdata_fifo (
		.clk               (pll_0_outclk2_clk),                                   //       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (adc_slave_agent_rdata_fifo_src_data),                 //        in.data
		.in_valid          (adc_slave_agent_rdata_fifo_src_valid),                //          .valid
		.in_ready          (adc_slave_agent_rdata_fifo_src_ready),                //          .ready
		.out_data          (adc_slave_agent_rdata_fifo_out_data),                 //       out.data
		.out_valid         (adc_slave_agent_rdata_fifo_out_valid),                //          .valid
		.out_ready         (adc_slave_agent_rdata_fifo_out_ready),                //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	soc_system_mm_interconnect_1_router_006 router_008 (
	...
	soc_system_mm_interconnect_1_router_009 router_009 (
		.sink_ready         (dsp_avalon_slave_agent_rp_ready),                     //      sink.ready
		.sink_valid         (dsp_avalon_slave_agent_rp_valid),                     //          .valid
		.sink_data          (dsp_avalon_slave_agent_rp_data),                      //          .data
		.sink_startofpacket (dsp_avalon_slave_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (dsp_avalon_slave_agent_rp_endofpacket),               //          .endofpacket
		.clk                (pll_0_outclk2_clk),                                   //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) dsp_avalon_slave_burst_adapter (
		.clk                   (pll_0_outclk2_clk),                                    //       cr0.clk
		.reset                 (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  // cr0_reset.reset
		...
		.source0_valid         (dsp_avalon_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (dsp_avalon_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (dsp_avalon_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (dsp_avalon_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (dsp_avalon_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (dsp_avalon_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (adc_slave_burst_adapter_source0_valid),               //   source0.valid
		.source0_data          (adc_slave_burst_adapter_source0_data),                //          .data
		.source0_channel       (adc_slave_burst_adapter_source0_channel),             //          .channel
		.source0_startofpacket (adc_slave_burst_adapter_source0_startofpacket),       //          .startofpacket
		.source0_endofpacket   (adc_slave_burst_adapter_source0_endofpacket),         //          .endofpacket
		.source0_ready         (adc_slave_burst_adapter_source0_ready)                //          .ready
	);
	...
	soc_system_mm_interconnect_1_cmd_demux_002 cmd_demux_004 (
		.clk                (pll_0_outclk2_clk),                                                //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	soc_system_mm_interconnect_1_cmd_mux_005 cmd_mux_005 (
		.clk                 (pll_0_outclk2_clk),                                                           //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                         // clk_reset.reset
		...
		.sink0_ready         (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_valid),         //          .valid
		.sink0_channel       (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_data          (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_startofpacket (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink1_ready         (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_ready),         //     sink1.ready
		.sink1_valid         (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_valid),         //          .valid
		.sink1_channel       (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink1_data          (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_data),          //          .data
		.sink1_startofpacket (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink1_endofpacket   (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	soc_system_mm_interconnect_1_rsp_demux_005 rsp_demux_005 (
		.clk                (pll_0_outclk2_clk),                                   //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_rsp_mux_002 rsp_mux_003 (
		...
		.sink3_ready         (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_ready),         //     sink3.ready
		.sink3_valid         (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_valid),         //          .valid
		.sink3_channel       (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_channel),       //          .channel
		.sink3_data          (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_data),          //          .data
		.sink3_startofpacket (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink3_endofpacket   (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);

	soc_system_mm_interconnect_1_rsp_mux_002 rsp_mux_004 (
		.clk                 (pll_0_outclk2_clk),                                                           //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		...
		.sink3_ready         (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_ready),         //     sink3.ready
		.sink3_valid         (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_valid),         //          .valid
		.sink3_channel       (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_channel),       //          .channel
		.sink3_data          (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_data),          //          .data
		.sink3_startofpacket (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink3_endofpacket   (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter (
		.clk                  (pll_0_outclk2_clk),                                                           //       clk.clk
		.reset                (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		...
		.out_endofpacket      (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (hps_0_h2f_lw_axi_master_wr_to_adc_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter (
		.clk                  (pll_0_outclk2_clk),                                                           //       clk.clk
		.reset                (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset),            // clk_reset.reset
		.in_valid             (cmd_demux_004_src3_valid),                                                    //      sink.valid
		.in_channel           (cmd_demux_004_src3_channel),                                                  //          .channel
		.in_startofpacket     (cmd_demux_004_src3_startofpacket),                                            //          .startofpacket
		.in_endofpacket       (cmd_demux_004_src3_endofpacket),                                              //          .endofpacket
		.in_ready             (cmd_demux_004_src3_ready),                                                    //          .ready
		.in_data              (cmd_demux_004_src3_data),                                                     //          .data
		.out_endofpacket      (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (hps_0_h2f_lw_axi_master_rd_to_adc_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter (
		.clk                  (pll_0_outclk2_clk),                                                           //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                         // clk_reset.reset
		...
		.out_endofpacket      (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_data),          //          .data
		.out_channel          (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (adc_slave_to_hps_0_h2f_lw_axi_master_wr_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                       // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter (
		.clk                  (pll_0_outclk2_clk),                                                           //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                         // clk_reset.reset
		...
		.out_endofpacket      (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_data),          //          .data
		.out_channel          (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (adc_slave_to_hps_0_h2f_lw_axi_master_rd_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                       // (terminated)
	);

	soc_system_mm_interconnect_1_mm_interconnect_5 mm_interconnect_5 (
		.pll_0_outclk2_clock_bridge_out_clk_clk                             (pll_0_outclk2_clk),                                                                    //                     pll_0_outclk2_clock_bridge_out_clk.clk
		.dsp_avalon_slave_agent_clk_reset_reset_bridge_in_reset_reset       (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),                                  // dsp_avalon_slave_agent_clk_reset_reset_bridge_in_reset.reset
		.dsp_avalon_slave_agent_m0_address                                  (dsp_avalon_slave_agent_m0_address),                                                    //                              dsp_avalon_slave_agent_m0.address
		.dsp_avalon_slave_agent_m0_waitrequest                              (dsp_avalon_slave_agent_m0_waitrequest),                                                //                                                       .waitrequest
		.dsp_avalon_slave_agent_m0_burstcount                               (dsp_avalon_slave_agent_m0_burstcount),                                                 //                                                       .burstcount
		.dsp_avalon_slave_agent_m0_byteenable                               (dsp_avalon_slave_agent_m0_byteenable),                                                 //                                                       .byteenable
		.dsp_avalon_slave_agent_m0_read                                     (dsp_avalon_slave_agent_m0_read),                                                       //                                                       .read
		.dsp_avalon_slave_agent_m0_readdata                                 (dsp_avalon_slave_agent_m0_readdata),                                                   //                                                       .readdata
		.dsp_avalon_slave_agent_m0_readdatavalid                            (dsp_avalon_slave_agent_m0_readdatavalid),                                              //                                                       .readdatavalid
		.dsp_avalon_slave_agent_m0_write                                    (dsp_avalon_slave_agent_m0_write),                                                      //                                                       .write
		.dsp_avalon_slave_agent_m0_writedata                                (dsp_avalon_slave_agent_m0_writedata),                                                  //                                                       .writedata
		.dsp_avalon_slave_agent_m0_lock                                     (dsp_avalon_slave_agent_m0_lock),                                                       //                                                       .lock
		.dsp_avalon_slave_agent_m0_debugaccess                              (dsp_avalon_slave_agent_m0_debugaccess),                                                //                                                       .debugaccess
		.dsp_avalon_slave_translator_avalon_universal_slave_0_address       (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_address),       //   dsp_avalon_slave_translator_avalon_universal_slave_0.address
		.dsp_avalon_slave_translator_avalon_universal_slave_0_burstcount    (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_burstcount),    //                                                       .burstcount
		.dsp_avalon_slave_translator_avalon_universal_slave_0_byteenable    (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_byteenable),    //                                                       .byteenable
		.dsp_avalon_slave_translator_avalon_universal_slave_0_debugaccess   (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_debugaccess),   //                                                       .debugaccess
		.dsp_avalon_slave_translator_avalon_universal_slave_0_lock          (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_lock),          //                                                       .lock
		.dsp_avalon_slave_translator_avalon_universal_slave_0_readdata      (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_readdata),      //                                                       .readdata
		.dsp_avalon_slave_translator_avalon_universal_slave_0_readdatavalid (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_readdatavalid), //                                                       .readdatavalid
		.dsp_avalon_slave_translator_avalon_universal_slave_0_read          (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_read),          //                                                       .read
		.dsp_avalon_slave_translator_avalon_universal_slave_0_waitrequest   (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_waitrequest),   //                                                       .waitrequest
		.dsp_avalon_slave_translator_avalon_universal_slave_0_writedata     (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_writedata),     //                                                       .writedata
		.dsp_avalon_slave_translator_avalon_universal_slave_0_write         (mm_interconnect_5_dsp_avalon_slave_translator_avalon_universal_slave_0_write)          //                                                       .write
	);
	...
	soc_system_mm_interconnect_1_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (pll_0_outclk2_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dsp_avalon_slave_agent_rdata_fifo_out_data),          //     in_0.data
		.in_0_valid     (dsp_avalon_slave_agent_rdata_fifo_out_valid),         //         .valid
		.in_0_ready     (dsp_avalon_slave_agent_rdata_fifo_out_ready),         //         .ready
	...
	soc_system_mm_interconnect_1_avalon_st_adapter_005 #(
		...
		.in_clk_0_clk   (pll_0_outclk2_clk),                                   // in_clk_0.clk
		.in_rst_0_reset (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (adc_slave_agent_rdata_fifo_out_data),                 //     in_0.data
		.in_0_valid     (adc_slave_agent_rdata_fifo_out_valid),                //         .valid
		.in_0_ready     (adc_slave_agent_rdata_fifo_out_ready),                //         .ready
