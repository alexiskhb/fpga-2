...
% ================================================================================
% Generated on: 05/10/2017 20:54:13
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_in_mlab(single_channel_data{i}, single_channel_bank{i});
