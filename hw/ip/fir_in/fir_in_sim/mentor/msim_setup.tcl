...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_in_rtl_core.vhd"                            
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_in_ast.vhd"                                 
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_in.vhd"                                     
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_in_tb.vhd"                                  
}
