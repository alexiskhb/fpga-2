...
function  output = fir_in_mlab(stimulation, bank);
 coef_matrix_in= [14,15,17,18,21,23,27,30,36,41,46,53,60,68,75,83,92,100,110,120,129,138,147,157,166,176,184,193,201,209,216,224,230,235,240,244,248,250,252,253,255,253,252,250,248,244,240,235,230,224,216,209,201,193,184,176,166,157,147,138,129,120,110,100,92,83,75,68,60,53,46,41,36,30,27,23,21,18,17,15,14];
 INTER_FACTOR  = 1;
 DECI_FACTOR  =  1;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
