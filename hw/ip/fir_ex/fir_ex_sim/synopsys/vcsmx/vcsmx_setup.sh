...
# ACDS 16.1 203 linux 2017.05.10.21:53:44
...
# ----------------------------------------
# If fir_ex is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_ex_rtl_core.vhd"                            
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_ex_ast.vhd"                                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_ex.vhd"                                     
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_ex_tb.vhd"                                  
fi
