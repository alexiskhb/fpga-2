...
add_interface_port fft_in in_valid valid Output 1
...
add_interface_port fft_out out_valid valid Input 1
add_interface_port fft_out Y data Input 64


# 
# connection point next_in
# 
add_interface next_in avalon_streaming start
set_interface_property next_in associatedClock clock_sink
set_interface_property next_in associatedReset reset_sink
set_interface_property next_in dataBitsPerSymbol 8
set_interface_property next_in errorDescriptor ""
set_interface_property next_in firstSymbolInHighOrderBits true
set_interface_property next_in maxChannel 0
set_interface_property next_in readyLatency 0
set_interface_property next_in ENABLED true
set_interface_property next_in EXPORT_OF ""
set_interface_property next_in PORT_NAME_MAP ""
set_interface_property next_in CMSIS_SVD_VARIABLES ""
set_interface_property next_in SVD_ADDRESS_GROUP ""

add_interface_port next_in next_in valid Output 1


# 
# connection point next_out
# 
add_interface next_out avalon_streaming end
set_interface_property next_out associatedClock clock_sink
set_interface_property next_out associatedReset reset_sink
set_interface_property next_out dataBitsPerSymbol 8
set_interface_property next_out errorDescriptor ""
set_interface_property next_out firstSymbolInHighOrderBits true
set_interface_property next_out maxChannel 0
set_interface_property next_out readyLatency 0
set_interface_property next_out ENABLED true
set_interface_property next_out EXPORT_OF ""
set_interface_property next_out PORT_NAME_MAP ""
set_interface_property next_out CMSIS_SVD_VARIABLES ""
set_interface_property next_out SVD_ADDRESS_GROUP ""

add_interface_port next_out next_out valid Input 1
