...
add_interface_port avalon_master avalon_master_chipselect chipselect Output 1
...
add_interface_port avalon_streaming_sink_1 avalon_streaming_sink_1_data data Input 32
