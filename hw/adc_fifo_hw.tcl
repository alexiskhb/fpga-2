...
# 
# connection point avalon_ss_fft_in
# 
add_interface avalon_ss_fft_in avalon_streaming start
set_interface_property avalon_ss_fft_in associatedClock clock_sink
set_interface_property avalon_ss_fft_in associatedReset reset_sink
set_interface_property avalon_ss_fft_in dataBitsPerSymbol 33
set_interface_property avalon_ss_fft_in errorDescriptor ""
set_interface_property avalon_ss_fft_in firstSymbolInHighOrderBits true
set_interface_property avalon_ss_fft_in maxChannel 0
set_interface_property avalon_ss_fft_in readyLatency 0
set_interface_property avalon_ss_fft_in ENABLED true
set_interface_property avalon_ss_fft_in EXPORT_OF ""
set_interface_property avalon_ss_fft_in PORT_NAME_MAP ""
set_interface_property avalon_ss_fft_in CMSIS_SVD_VARIABLES ""
set_interface_property avalon_ss_fft_in SVD_ADDRESS_GROUP ""

add_interface_port avalon_ss_fft_in fft_in_data data Output 33
add_interface_port avalon_ss_fft_in fft_in_eop endofpacket Output 1
add_interface_port avalon_ss_fft_in fft_in_err error Output 2
add_interface_port avalon_ss_fft_in fft_in_ready ready Input 1
add_interface_port avalon_ss_fft_in fft_in_sop startofpacket Output 1
add_interface_port avalon_ss_fft_in fft_in_valid valid Output 1


# 
# connection point avalon_ss_fft_out
# 
add_interface avalon_ss_fft_out avalon_streaming end
set_interface_property avalon_ss_fft_out associatedClock clock_sink
set_interface_property avalon_ss_fft_out associatedReset reset_sink
set_interface_property avalon_ss_fft_out dataBitsPerSymbol 38
set_interface_property avalon_ss_fft_out errorDescriptor ""
set_interface_property avalon_ss_fft_out firstSymbolInHighOrderBits true
set_interface_property avalon_ss_fft_out maxChannel 0
set_interface_property avalon_ss_fft_out readyLatency 0
set_interface_property avalon_ss_fft_out ENABLED true
set_interface_property avalon_ss_fft_out EXPORT_OF ""
set_interface_property avalon_ss_fft_out PORT_NAME_MAP ""
set_interface_property avalon_ss_fft_out CMSIS_SVD_VARIABLES ""
set_interface_property avalon_ss_fft_out SVD_ADDRESS_GROUP ""

add_interface_port avalon_ss_fft_out fft_out_data data Input 38
add_interface_port avalon_ss_fft_out fft_out_eop endofpacket Input 1
add_interface_port avalon_ss_fft_out fft_out_sop startofpacket Input 1
add_interface_port avalon_ss_fft_out fft_out_err error Input 2
add_interface_port avalon_ss_fft_out fft_out_ready ready Output 1
add_interface_port avalon_ss_fft_out fft_out_valid valid Input 1
